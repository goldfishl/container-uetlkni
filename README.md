...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uetlkni.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uetlkni.containers.anotherwebservice.com/
...
```
git clone git@github.com:goldfishl/container-uetlkni.git
cd container-uetlkni
```
...
```
docker attach container-uetlkni
```
